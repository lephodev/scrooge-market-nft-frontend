        ...
        <nav className='header-nav-container-mobile'>
          <div className='header-nav-menu-mobile'>
            <ul>
              ...
              <li
                onClick={() => handleclick("crypto-to-tokens")}
                className={
                  active && active === "crypto-to-tokens" ? "active" : ""
                }
              >
...
const WalletSvg = () => {
  return (
    ...
    >
      <path
        d='M87.4333 0.900314C47.0333 8.10031 13.4333 39.167 2.5 79.4336C-0.833333 91.4336 -0.833333 120.767 2.5 132.767C11.8333 167.167 38.6333 195.967 71.1667 206.634C100.5 216.367 128.367 214.1 155.967 199.7C173.167 190.767 190.9 173.034 199.567 156.1C203.033 149.434 207.033 139.567 208.5 134.1C218.5 98.2336 208.233 58.6337 182.1 31.8336C162.1 11.4336 138.5 0.900314 109.967 0.100314C101.567 -0.166352 91.4333 0.100314 87.4333 0.900314ZM144.9 59.0337C146.233 60.2337 147.3 63.0337 147.3 65.7003V70.1003L109.7 69.967L71.9667 69.8337L102.633 63.4337C136.9 56.2337 141.3 55.8337 144.9 59.0337ZM154.633 81.4336C156.633 83.3003 157.967 86.2336 157.967 88.5003V92.5003L143.167 93.0336C123.967 93.567 123.3 94.367 123.3 111.834C123.3 122.367 123.7 124.367 126.233 127.034C128.9 129.834 130.233 130.1 143.567 130.1H157.967V134.1C157.967 139.834 155.433 144.367 151.433 146.1C148.9 147.034 133.7 147.434 103.433 147.167L59.0333 146.767L56.5 143.567C54.2333 140.767 53.9667 138.1 53.9667 112.5C53.9667 84.767 53.9667 84.6336 57.3 81.4336L60.5 78.1003H105.967H151.433L154.633 81.4336ZM161.967 111.434V122.1H146.633H131.3V111.434V100.767H146.633H161.967V111.434Z'
        fill='black'
      />
    </svg>
  );
