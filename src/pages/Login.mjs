      ...
      <div className="main login-page">
        ...
        <div className="login-page-body">
          ...
          <div className="login-page-desc">
            ...
            Please <a href={`${scroogeClient}`} /* target="_blank" */ rel="noreferrer" alt="Login to Scrooge Casino">LOG IN</a> and then return to the marketplace.
          </div>
          <a href={`${scroogeClient}`} /* target="_blank" */ rel="noreferrer" alt="Login to Scrooge Casino"><button className="submit-btn">LOGIN TO YOUR SCROOGE CASINO ACCOUNT</button></a>
        </div>
      </div>
    </div>
    </Layout>
