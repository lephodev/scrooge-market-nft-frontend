...
export default function ShowBottomNavCards() {
   return ( <div className="grid">
          <Link to="/nft-tokens" className="card">
            ...
            <img className="card-img" src={Casino} alt="scrooge casino nft token packages" />
          </Link>
          ...
          <a href="https://scrooge.casino" className="card" rel="noreferrer">
            ...
            <img className="card-img" src={PokerChips} alt="Redeem your token NFTs" />
          </a>
          ...
          <Link to="/my-wallet" className="card">
            ...
            <p>
              Peruse all of your digital goodies. You might just find that you need something new!
            </p>
