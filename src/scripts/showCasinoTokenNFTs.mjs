        ...
        <div className='flex-row nft-home-sell-div'>
          <div className='nft-home-sell-card'>
            ...
            <div className='nft-home-sell-details'>
              ...
              <br></br>
              <br></br>
              SPECIAL: GET {listings[0].asset.attributes[2].value.toString()}{" "}
              FREE TOKENS!<br></br>
              <button
          ...
          <div className='nft-home-sell-card'>
            ...
            <div className='nft-home-sell-details'>
              ...
              <br></br>
              <br></br>
              SPECIAL: GET {listings[1].asset.attributes[2].value.toString()}{" "}
              FREE TOKENS!<br></br>
              <button
                className='erc1155-buy-btn'
                onClick={routeChange}
          ...
          <div className='nft-home-sell-card'>
            ...
            <div className='nft-home-sell-details'>
              ...
              <br></br>
              <br></br>
              SPECIAL: GET {listings[2].asset.attributes[2].value.toString()}{" "}
              FREE TOKENS!<br></br>
              <button
                className='erc1155-buy-btn'
                onClick={routeChange}
          ...
          <div className='nft-home-sell-card'>
            ...
            <div className='nft-home-sell-details'>
              ...
              <br></br>
              <br></br>
              SPECIAL: GET {listings[3].asset.attributes[2].value.toString()}{" "}
              FREE TOKENS!<br></br>
              <button
                className='erc1155-buy-btn'
                onClick={routeChange}
